...
public class ProvinciaControl {
     ...
     public void crear(String[] data) { 
         ...
         var year=Integer.valueOf(data[5]);
         var mes=Integer.valueOf(data[6]);
         var dia=Integer.valueOf(data[7]);
         
         var provincia = new Provincia (codigoProvincia,nombrePais,nombreProvincia,nroCanton,habitantes,LocalDate.of(year,mes,dia));
