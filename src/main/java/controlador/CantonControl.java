...
public class CantonControl {
    ...
    public void crear(String[] data) {
        ...
        var nroPoblacion = Integer.valueOf(data[3]);
        var year=Integer.valueOf(data[4]);
        var mes=Integer.valueOf(data[5]);
        var dia=Integer.valueOf(data[6]);
        
        var canton = new Canton (codigoCanton,nombreCanton,nombreProvincia,nroPoblacion,LocalDate.of(year,mes,dia));
    ...
    public String modificar(String[] data) {
        ...
        var mes=Integer.valueOf(data[5]);
        var dia=Integer.valueOf(data[6]);
        var cantonModificado=Integer.valueOf(data[7]);
