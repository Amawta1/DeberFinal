...
public class PaisServiceImpl implements PaisService {
    ...
    public void almacenarArchivo(Pais pais, String ruta) {
        ...
        try {
            ...
            salida.writeUTF(pais.getNombreContinente());
    ...
    public List<Pais> recuperarArchivo(String ruta) {
        ...
        try {
            ...
            while (true) {
                ...
                var nombreContinente = entrada.readUTF();
                var nombrePais = entrada.readUTF();
                var poblacion = entrada.readInt();
                var nroProvincias = entrada.readInt();
                var pais = new Pais(codigoPais, nombreContinente, nombrePais, poblacion, nroProvincias);
                paisList.add(pais);
            }
        } catch (IOException e) {
            try {
